...
INSERT INTO product_table
 ...
 ('不苦労ミニだるま', 'インテリア', 980, 50, '幸運を呼ぶフクロウをモチーフにした小さなサイズのだるま。大きさ約5センチ。<br>玄関やリビングでそっとあなたを見守ります。', 'img/sample_1.png'),
 ('にわとりさんアラーム', 'インテリア', 1480, 50, 'コンパクトサイズの目覚まし時計。<br>つぶらな瞳とエネルギッシュなアラーム音で寝起きを応援！', 'img/sample_1.png'),
 ('小鳥達のマドラーセット', 'キッチン用品', 1580, 50, 'メジロ、スズメ、ゴジュウカラの3羽をモチーフにしたマドラー3本セット。' , 'img/sample_1.png'),
 ('オリジナルブックカバー', 'ステーショナリー', 580, 50, '文庫本サイズのブックカバーです。しおり紐のつばめがワンポイント。', 'img/sample_1.png');
