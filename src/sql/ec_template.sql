...
INSERT INTO product_table
 ...
 ('かもめハンガー', 'インテリア',480, 50, '羽を広げたかもめの形のハンガーです。2本セット。', 'img/[05]かもめハンガー.png'),
 ('小鳥達のマドラーセット', 'キッチン用品', 980, 50, 'メジロとスズメをモチーフにしたマドラー2本セット。', 'img/[06]小鳥たちのマドラーセット.png'),
 ('オリジナルブックカバー', 'ステーショナリー', 580, 50, '文庫本サイズのブックカバーです。しおり紐の青い鳥がワンポイント。', 'img/[07]オリジナルブックカバー.png'),
 ...
 ('すやすや鳥の巣オルゴール', 'インテリア', 2980, 50, '巣の中で眠るつばめの親子をモチーフにしたオルゴールです。優しい音色で就寝時のお供にも。', 'img/[10]すやすや鳥の巣オルゴール.png'),
